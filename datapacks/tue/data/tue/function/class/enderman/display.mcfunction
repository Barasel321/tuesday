...
title @s actionbar [{"text":"New ender pearl in "},{"score":{"name":".second","objective":"temp"},"color":"red"},{"text":".","color":"red"},{"score":{"name":".tick","objective":"temp"},"color":"red"},{"text":" s","color":"red"}]