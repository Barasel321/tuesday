...
summon item_display 4 2.5 12 {billboard:"center",item:{id:"minecraft:skeleton_skull"}}
summon item_display 2 2.5 12 {billboard:"center",item:{id:"minecraft:clock"}}
summon item_display 0 2.5 12 {billboard:"center",item:{id:"minecraft:oak_sapling"}}
summon item_display -2 2.5 12 {billboard:"center",item:{id:"minecraft:firework_rocket"}}
