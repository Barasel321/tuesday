...
execute if score @s ability > .tp ability run function tue:class/ninja/display_tp
execute if score @s ability <= .tp ability run function tue:class/ninja/display
