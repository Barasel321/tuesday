scoreboard players set .max class 3
scoreboard players set .max rounds 1

scoreboard players set .red alive 0
scoreboard players set .blue alive 0
scoreboard players set .yellow alive 0
scoreboard players set .lime alive 0
scoreboard players set .white alive 0
scoreboard players set .black alive 0
